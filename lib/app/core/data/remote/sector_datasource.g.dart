...
part of 'sector_datasource.dart';
...
class _SectorDataSource implements SectorDataSource {
  _SectorDataSource(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<HttpResponse<ApiResponse>> getById({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<ApiResponse>> delete({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
